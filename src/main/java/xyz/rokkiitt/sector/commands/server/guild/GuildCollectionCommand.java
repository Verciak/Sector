...
import xyz.rokkiitt.sector.objects.guild.collection.CollectionInventory;
...
public class GuildCollectionCommand extends ServerCommand
{
    public GuildCollectionCommand() {
        super("skladki", "otwiera skladki gildii", "/skladki", "", new String[0]);
    }
    ...
    public boolean onCommand(final Player p, final String[] args) {
        ...
        if (u != null) {
            ...
            p.addWindow((Inventory)new CollectionInventory(p, u, g));
        }
        else {
