...
public class PremiumCaseDropInventory extends DoubleChestFakeInventory {

    private final User u;
    private final Player who;

    public PremiumCaseDropInventory(final Player p, final User u) {
    ...
    private void refreshGui() {
        ...
        for (final PremiumCase id : PremiumCaseManager.getItems()) {
